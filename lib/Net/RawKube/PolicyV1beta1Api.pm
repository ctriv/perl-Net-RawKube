...
#
package Net::RawKube::PolicyV1beta1Api;
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    'body' => {
        data_type => 'V1beta1PodDisruptionBudget',
        description => '',
        required => '1',
    },
    'pretty' => {
    ...
    __PACKAGE__->method_documentation->{ 'create_namespaced_pod_disruption_budget' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudget',
        };
}
# @return V1beta1PodDisruptionBudget
#
sub create_namespaced_pod_disruption_budget {
    my ($self, %args) = @_;

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling create_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_namespaced_pod_disruption_budget");
    }

    # parse inputs
    my $_resource_path = '/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1PodDisruptionBudget', $response);
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_namespaced_pod_disruption_budget' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_namespaced_pod_disruption_budget {
    my ($self, %args) = @_;

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling delete_collection_namespaced_pod_disruption_budget");
    }
...
# @param string $propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_namespaced_pod_disruption_budget' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_namespaced_pod_disruption_budget {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling delete_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling delete_namespaced_pod_disruption_budget");
    }

    # parse inputs
    my $_resource_path = '/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/policy/v1beta1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_namespaced_pod_disruption_budget' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudgetList',
        };
}
# @return V1beta1PodDisruptionBudgetList
#
sub list_namespaced_pod_disruption_budget {
    my ($self, %args) = @_;

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling list_namespaced_pod_disruption_budget");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1PodDisruptionBudgetList', $response);
    return $_response_object;
}
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_pod_disruption_budget_for_all_namespaces' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudgetList',
        };
...
# @return V1beta1PodDisruptionBudgetList
#
sub list_pod_disruption_budget_for_all_namespaces {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/apis/policy/v1beta1/poddisruptionbudgets';
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_namespaced_pod_disruption_budget' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudget',
        };
...
# @return V1beta1PodDisruptionBudget
#
sub patch_namespaced_pod_disruption_budget {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling patch_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_namespaced_pod_disruption_budget");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_namespaced_pod_disruption_budget_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudget',
        };
...
# @return V1beta1PodDisruptionBudget
#
sub patch_namespaced_pod_disruption_budget_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_namespaced_pod_disruption_budget_status");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling patch_namespaced_pod_disruption_budget_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_namespaced_pod_disruption_budget_status");
    }

    # parse inputs
    my $_resource_path = '/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status';
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_namespaced_pod_disruption_budget' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudget',
        };
...
# @return V1beta1PodDisruptionBudget
#
sub read_namespaced_pod_disruption_budget {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling read_namespaced_pod_disruption_budget");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_namespaced_pod_disruption_budget_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudget',
        };
...
# @return V1beta1PodDisruptionBudget
#
sub read_namespaced_pod_disruption_budget_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_namespaced_pod_disruption_budget_status");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling read_namespaced_pod_disruption_budget_status");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_namespaced_pod_disruption_budget' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudget',
        };
...
# @return V1beta1PodDisruptionBudget
#
sub replace_namespaced_pod_disruption_budget {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling replace_namespaced_pod_disruption_budget");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_namespaced_pod_disruption_budget");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_namespaced_pod_disruption_budget_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1PodDisruptionBudget',
        };
...
# @return V1beta1PodDisruptionBudget
#
sub replace_namespaced_pod_disruption_budget_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_namespaced_pod_disruption_budget_status");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling replace_namespaced_pod_disruption_budget_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_namespaced_pod_disruption_budget_status");
    }
