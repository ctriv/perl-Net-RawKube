...
#
package Net::RawKube::CertificatesV1beta1Api;
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    my $params = {
    'body' => {
        data_type => 'V1beta1CertificateSigningRequest',
        description => '',
        required => '1',
    },
    'pretty' => {
    ...
    __PACKAGE__->method_documentation->{ 'create_certificate_signing_request' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
}
# @return V1beta1CertificateSigningRequest
#
sub create_certificate_signing_request {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_certificate_signing_request");
    }

    # parse inputs
    my $_resource_path = '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CertificateSigningRequest', $response);
...
# @param string $propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_certificate_signing_request' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_certificate_signing_request {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_certificate_signing_request");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling delete_certificate_signing_request");
    }

    # parse inputs
    my $_resource_path = '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_certificate_signing_request' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_certificate_signing_request {
    my ($self, %args) = @_;
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/certificates.k8s.io/v1beta1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_certificate_signing_request' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequestList',
        };
}
# @return V1beta1CertificateSigningRequestList
#
sub list_certificate_signing_request {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1CertificateSigningRequestList', $response);
    return $_response_object;
}
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_certificate_signing_request' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
...
# @return V1beta1CertificateSigningRequest
#
sub patch_certificate_signing_request {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_certificate_signing_request");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_certificate_signing_request");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_certificate_signing_request' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
...
# @return V1beta1CertificateSigningRequest
#
sub read_certificate_signing_request {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_certificate_signing_request");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_certificate_signing_request' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
...
# @return V1beta1CertificateSigningRequest
#
sub replace_certificate_signing_request {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_certificate_signing_request");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_certificate_signing_request");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_certificate_signing_request_approval' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
...
# @return V1beta1CertificateSigningRequest
#
sub replace_certificate_signing_request_approval {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_certificate_signing_request_approval");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_certificate_signing_request_approval");
    }

    # parse inputs
    my $_resource_path = '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval';
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_certificate_signing_request_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1CertificateSigningRequest',
        };
...
# @return V1beta1CertificateSigningRequest
#
sub replace_certificate_signing_request_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_certificate_signing_request_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_certificate_signing_request_status");
    }

    # parse inputs
    my $_resource_path = '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status';
