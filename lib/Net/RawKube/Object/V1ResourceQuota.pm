...
#
package Net::RawKube::Object::V1ResourceQuota;
...
__PACKAGE__->class_documentation({description => 'ResourceQuota sets aggregate quota restrictions enforced per namespace',
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
    	datatype => 'V1ResourceQuotaStatus',
    	base_name => 'status',
