...
#
package Net::RawKube::Object::V1PodTemplateSpec;
...
__PACKAGE__->class_documentation({description => 'PodTemplateSpec describes the data a pod should have when created from a template',
