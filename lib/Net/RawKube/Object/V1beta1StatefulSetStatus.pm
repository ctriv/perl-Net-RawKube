...
#
package Net::RawKube::Object::V1beta1StatefulSetStatus;
...
__PACKAGE__->class_documentation({description => 'StatefulSetStatus represents the current state of a StatefulSet.',
