...
#
package Net::RawKube::Object::V1PodCondition;
...
__PACKAGE__->class_documentation({description => 'PodCondition contains details for the current condition of this pod.',
