...
#
package Net::RawKube::Object::V1alpha1ExternalAdmissionHook;
...
__PACKAGE__->class_documentation({description => 'ExternalAdmissionHook describes an external admission webhook and the resources and operations it applies to.',
...
__PACKAGE__->method_documentation({
    'client_config' => {
    	datatype => 'V1alpha1AdmissionHookClientConfig',
    ...
    'rules' => {
    	datatype => 'ARRAY[V1alpha1RuleWithOperations]',
    	base_name => 'rules',
