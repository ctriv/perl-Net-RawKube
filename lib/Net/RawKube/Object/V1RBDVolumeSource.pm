...
#
package Net::RawKube::Object::V1RBDVolumeSource;
...
__PACKAGE__->class_documentation({description => 'Represents a Rados Block Device mount that lasts the lifetime of a pod. RBD volumes support ownership management and SELinux relabeling.',
