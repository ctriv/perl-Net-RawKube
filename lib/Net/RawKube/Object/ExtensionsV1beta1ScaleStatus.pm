...
#
package Net::RawKube::Object::ExtensionsV1beta1ScaleStatus;
...
__PACKAGE__->class_documentation({description => 'represents the current status of a scale subresource.',
