...
#
package Net::RawKube::Object::ExtensionsV1beta1DeploymentRollback;
...
__PACKAGE__->class_documentation({description => 'DeploymentRollback stores the information required to rollback a deployment.',
