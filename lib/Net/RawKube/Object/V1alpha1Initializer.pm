...
#
package Net::RawKube::Object::V1alpha1Initializer;
...
__PACKAGE__->class_documentation({description => 'Initializer describes the name and the failure policy of an initializer, and what resources it applies to.',
