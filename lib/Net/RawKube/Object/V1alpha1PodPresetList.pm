...
#
package Net::RawKube::Object::V1alpha1PodPresetList;
...
__PACKAGE__->class_documentation({description => 'PodPresetList is a list of PodPreset objects.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1alpha1PodPreset]',
    	base_name => 'items',
