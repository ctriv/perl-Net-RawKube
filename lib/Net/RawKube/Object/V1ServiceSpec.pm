...
#
package Net::RawKube::Object::V1ServiceSpec;
...
__PACKAGE__->class_documentation({description => 'ServiceSpec describes the attributes that a user creates on a service.',
                                  class => 'V1ServiceSpec',
                                  required => [], # TODO
}                                 );
