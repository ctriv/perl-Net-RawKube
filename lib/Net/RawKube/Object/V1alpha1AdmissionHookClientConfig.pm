...
#
package Net::RawKube::Object::V1alpha1AdmissionHookClientConfig;
...
__PACKAGE__->class_documentation({description => 'AdmissionHookClientConfig contains the information to make a TLS connection with the webhook',
