...
#
package Net::RawKube::Object::V1PersistentVolumeClaimList;
...
__PACKAGE__->class_documentation({description => 'PersistentVolumeClaimList is a list of PersistentVolumeClaim items.',
