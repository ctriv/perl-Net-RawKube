...
#
package Net::RawKube::Object::V1beta1StorageClassList;
...
__PACKAGE__->class_documentation({description => 'StorageClassList is a collection of storage classes.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1beta1StorageClass]',
    	base_name => 'items',
