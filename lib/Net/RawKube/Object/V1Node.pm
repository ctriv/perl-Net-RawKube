...
#
package Net::RawKube::Object::V1Node;
...
__PACKAGE__->class_documentation({description => 'Node is a worker node in Kubernetes. Each node will have a unique identifier in the cache (i.e. in etcd).',
                                  class => 'V1Node',
                                  required => [], # TODO
}                                 );
