...
#
package Net::RawKube::Object::V1beta1NetworkPolicyList;
...
__PACKAGE__->class_documentation({description => 'Network Policy List is a list of NetworkPolicy objects.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1beta1NetworkPolicy]',
    	base_name => 'items',
