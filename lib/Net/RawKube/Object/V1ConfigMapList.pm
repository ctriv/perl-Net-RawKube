...
#
package Net::RawKube::Object::V1ConfigMapList;
...
__PACKAGE__->class_documentation({description => 'ConfigMapList is a resource containing a list of ConfigMap objects.',
