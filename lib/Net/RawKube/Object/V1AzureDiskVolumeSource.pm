...
#
package Net::RawKube::Object::V1AzureDiskVolumeSource;
...
__PACKAGE__->class_documentation({description => 'AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod.',
