...
#
package Net::RawKube::Object::V1ReplicationControllerStatus;
...
__PACKAGE__->class_documentation({description => 'ReplicationControllerStatus represents the current status of a replication controller.',
...
__PACKAGE__->method_documentation({
    ...
    'conditions' => {
    	datatype => 'ARRAY[V1ReplicationControllerCondition]',
