...
#
package Net::RawKube::Object::V1PersistentVolumeClaimStatus;
...
__PACKAGE__->class_documentation({description => 'PersistentVolumeClaimStatus is the current status of a persistent volume claim.',
