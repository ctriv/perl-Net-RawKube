...
#
package Net::RawKube::Object::V2alpha1CronJob;
...
__PACKAGE__->class_documentation({description => 'CronJob represents the configuration of a single cron job.',
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
    	datatype => 'V2alpha1CronJobStatus',
    	base_name => 'status',
