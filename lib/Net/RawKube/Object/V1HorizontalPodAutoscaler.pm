...
#
package Net::RawKube::Object::V1HorizontalPodAutoscaler;
...
__PACKAGE__->class_documentation({description => 'configuration of a horizontal pod autoscaler.',
...
__PACKAGE__->method_documentation({
    ...
    'spec' => {
    	datatype => 'V1HorizontalPodAutoscalerSpec',
    	base_name => 'spec',
    ...
    'status' => {
    	datatype => 'V1HorizontalPodAutoscalerStatus',
    	base_name => 'status',
