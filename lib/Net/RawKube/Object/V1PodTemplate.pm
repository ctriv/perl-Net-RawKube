...
#
package Net::RawKube::Object::V1PodTemplate;
...
__PACKAGE__->class_documentation({description => 'PodTemplate describes a template for creating copies of a predefined pod.',
                                  class => 'V1PodTemplate',
                                  required => [], # TODO
}                                 );
