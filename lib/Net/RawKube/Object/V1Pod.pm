...
#
package Net::RawKube::Object::V1Pod;
...
__PACKAGE__->class_documentation({description => 'Pod is a collection of containers that can run on a host. This resource is created by clients and scheduled onto hosts.',
                                  class => 'V1Pod',
                                  required => [], # TODO
}                                 );
