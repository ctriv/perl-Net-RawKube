...
#
package Net::RawKube::Object::V1NetworkPolicyPeer;
...
__PACKAGE__->class_documentation({description => 'NetworkPolicyPeer describes a peer to allow traffic from. Exactly one of its fields must be specified.',
