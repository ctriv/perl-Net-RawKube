...
#
package Net::RawKube::Object::V1beta1NetworkPolicyIngressRule;
...
__PACKAGE__->class_documentation({description => 'This NetworkPolicyIngressRule matches traffic if and only if the traffic matches both ports AND from.',
