...
#
package Net::RawKube::Object::AppsV1beta1ScaleStatus;
...
__PACKAGE__->class_documentation({description => 'ScaleStatus represents the current status of a scale subresource.',
