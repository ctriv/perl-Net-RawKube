...
#
package Net::RawKube::Object::V1ResourceQuotaSpec;
...
__PACKAGE__->class_documentation({description => 'ResourceQuotaSpec defines the desired hard limits to enforce for Quota.',
