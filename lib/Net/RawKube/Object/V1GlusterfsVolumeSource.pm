...
#
package Net::RawKube::Object::V1GlusterfsVolumeSource;
...
__PACKAGE__->class_documentation({description => 'Represents a Glusterfs mount that lasts the lifetime of a pod. Glusterfs volumes do not support ownership management or SELinux relabeling.',
