...
#
package Net::RawKube::Object::V1LimitRange;
...
__PACKAGE__->class_documentation({description => 'LimitRange sets resource usage limits for each kind of resource in a Namespace.',
                                  class => 'V1LimitRange',
                                  required => [], # TODO
}                                 );
