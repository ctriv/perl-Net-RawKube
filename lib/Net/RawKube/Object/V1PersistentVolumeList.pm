...
#
package Net::RawKube::Object::V1PersistentVolumeList;
...
__PACKAGE__->class_documentation({description => 'PersistentVolumeList is a list of PersistentVolume items.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1PersistentVolume]',
    	base_name => 'items',
