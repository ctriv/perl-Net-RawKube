...
#
package Net::RawKube::Object::V1beta1DaemonSetList;
...
__PACKAGE__->class_documentation({description => 'DaemonSetList is a collection of daemon sets.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1beta1DaemonSet]',
    	base_name => 'items',
