...
#
package Net::RawKube::Object::V1alpha1ExternalAdmissionHookConfigurationList;
...
__PACKAGE__->class_documentation({description => 'ExternalAdmissionHookConfigurationList is a list of ExternalAdmissionHookConfiguration.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1alpha1ExternalAdmissionHookConfiguration]',
    	base_name => 'items',
