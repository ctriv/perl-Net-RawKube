...
#
package Net::RawKube::Object::V1PersistentVolume;
...
__PACKAGE__->class_documentation({description => 'PersistentVolume (PV) is a storage resource provisioned by an administrator. It is analogous to a node. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes',
...
__PACKAGE__->method_documentation({
    ...
    'spec' => {
    	datatype => 'V1PersistentVolumeSpec',
    	base_name => 'spec',
    ...
    'status' => {
    	datatype => 'V1PersistentVolumeStatus',
    	base_name => 'status',
