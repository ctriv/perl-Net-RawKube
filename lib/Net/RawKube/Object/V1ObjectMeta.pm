...
#
package Net::RawKube::Object::V1ObjectMeta;
...
__PACKAGE__->class_documentation({description => 'ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.',
                                  class => 'V1ObjectMeta',
                                  required => [], # TODO
}                                 );
