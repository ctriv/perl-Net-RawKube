...
#
package Net::RawKube::Object::V1beta1PodSecurityPolicyList;
...
__PACKAGE__->class_documentation({description => 'Pod Security Policy List is a list of PodSecurityPolicy objects.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1beta1PodSecurityPolicy]',
    	base_name => 'items',
