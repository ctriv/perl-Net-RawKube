...
#
package Net::RawKube::Object::V1beta1ControllerRevisionList;
...
__PACKAGE__->class_documentation({description => 'ControllerRevisionList is a resource containing a list of ControllerRevision objects.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1beta1ControllerRevision]',
    	base_name => 'items',
