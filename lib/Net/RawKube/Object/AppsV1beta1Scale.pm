...
#
package Net::RawKube::Object::AppsV1beta1Scale;
...
__PACKAGE__->class_documentation({description => 'Scale represents a scaling request for a resource.',
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
    	datatype => 'AppsV1beta1ScaleStatus',
    	base_name => 'status',
