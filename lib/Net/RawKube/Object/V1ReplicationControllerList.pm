...
#
package Net::RawKube::Object::V1ReplicationControllerList;
...
__PACKAGE__->class_documentation({description => 'ReplicationControllerList is a collection of replication controllers.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1ReplicationController]',
    	base_name => 'items',
