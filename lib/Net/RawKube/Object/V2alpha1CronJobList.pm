...
#
package Net::RawKube::Object::V2alpha1CronJobList;
...
__PACKAGE__->class_documentation({description => 'CronJobList is a collection of cron jobs.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V2alpha1CronJob]',
    	base_name => 'items',
