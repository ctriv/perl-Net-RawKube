...
#
package Net::RawKube::Object::V1ScaleIOVolumeSource;
...
__PACKAGE__->class_documentation({description => 'ScaleIOVolumeSource represents a persistent ScaleIO volume',
