...
#
package Net::RawKube::Object::V2alpha1JobTemplateSpec;
...
__PACKAGE__->class_documentation({description => 'JobTemplateSpec describes the data a Job should have when created from a template',
