...
#
package Net::RawKube::Object::V1beta1DaemonSet;
...
__PACKAGE__->class_documentation({description => 'DaemonSet represents the configuration of a daemon set.',
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
    	datatype => 'V1beta1DaemonSetStatus',
    	base_name => 'status',
