...
#
package Net::RawKube::Object::V2alpha1PodsMetricStatus;
...
__PACKAGE__->class_documentation({description => 'PodsMetricStatus indicates the current value of a metric describing each pod in the current scale target (for example, transactions-processed-per-second).',
                                  class => 'V2alpha1PodsMetricStatus',
                                  required => [], # TODO
}                                 );
