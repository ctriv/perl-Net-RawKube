...
#
package Net::RawKube::Object::V1Namespace;
...
__PACKAGE__->class_documentation({description => 'Namespace provides a scope for Names. Use of multiple namespaces is optional.',
                                  class => 'V1Namespace',
                                  required => [], # TODO
}                                 );
