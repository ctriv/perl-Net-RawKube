...
#
package Net::RawKube::Object::ExtensionsV1beta1Scale;
...
__PACKAGE__->class_documentation({description => 'represents a scaling request for a resource.',
...
__PACKAGE__->method_documentation({
    ...
    'spec' => {
    	datatype => 'ExtensionsV1beta1ScaleSpec',
    	base_name => 'spec',
    ...
    'status' => {
    	datatype => 'ExtensionsV1beta1ScaleStatus',
    	base_name => 'status',
