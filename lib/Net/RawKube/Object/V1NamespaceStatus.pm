...
#
package Net::RawKube::Object::V1NamespaceStatus;
...
__PACKAGE__->class_documentation({description => 'NamespaceStatus is information about the current status of a Namespace.',
