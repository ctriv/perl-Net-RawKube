...
#
package Net::RawKube::Object::V1StorageOSPersistentVolumeSource;
...
__PACKAGE__->class_documentation({description => 'Represents a StorageOS persistent volume resource.',
