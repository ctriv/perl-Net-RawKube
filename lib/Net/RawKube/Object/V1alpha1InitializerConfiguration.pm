...
#
package Net::RawKube::Object::V1alpha1InitializerConfiguration;
...
__PACKAGE__->class_documentation({description => 'InitializerConfiguration describes the configuration of initializers.',
...
__PACKAGE__->method_documentation({
    ...
    'initializers' => {
    	datatype => 'ARRAY[V1alpha1Initializer]',
