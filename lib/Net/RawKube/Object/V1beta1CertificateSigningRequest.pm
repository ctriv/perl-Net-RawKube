...
#
package Net::RawKube::Object::V1beta1CertificateSigningRequest;
...
__PACKAGE__->class_documentation({description => 'Describes a certificate signing request',
...
__PACKAGE__->method_documentation({
    ...
    'spec' => {
    	datatype => 'V1beta1CertificateSigningRequestSpec',
    	base_name => 'spec',
    ...
    'status' => {
    	datatype => 'V1beta1CertificateSigningRequestStatus',
    	base_name => 'status',
