...
#
package Net::RawKube::Object::V1ResourceQuotaList;
...
__PACKAGE__->class_documentation({description => 'ResourceQuotaList is a list of ResourceQuota items.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1ResourceQuota]',
    	base_name => 'items',
