...
#
package Net::RawKube::Object::V1ResourceQuotaStatus;
...
__PACKAGE__->class_documentation({description => 'ResourceQuotaStatus defines the enforced hard limits and observed use.',
