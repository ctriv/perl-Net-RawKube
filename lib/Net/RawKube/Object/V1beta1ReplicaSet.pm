...
#
package Net::RawKube::Object::V1beta1ReplicaSet;
...
__PACKAGE__->class_documentation({description => 'ReplicaSet represents the configuration of a ReplicaSet.',
...
__PACKAGE__->method_documentation({
    ...
    'spec' => {
    	datatype => 'V1beta1ReplicaSetSpec',
    	base_name => 'spec',
    ...
    'status' => {
    	datatype => 'V1beta1ReplicaSetStatus',
    	base_name => 'status',
