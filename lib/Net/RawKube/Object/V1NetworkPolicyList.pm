...
#
package Net::RawKube::Object::V1NetworkPolicyList;
...
__PACKAGE__->class_documentation({description => 'NetworkPolicyList is a list of NetworkPolicy objects.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1NetworkPolicy]',
    	base_name => 'items',
