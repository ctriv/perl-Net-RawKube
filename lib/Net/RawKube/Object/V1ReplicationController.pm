...
#
package Net::RawKube::Object::V1ReplicationController;
...
__PACKAGE__->class_documentation({description => 'ReplicationController represents the configuration of a replication controller.',
...
__PACKAGE__->method_documentation({
    ...
    'spec' => {
    	datatype => 'V1ReplicationControllerSpec',
    	base_name => 'spec',
    ...
    'status' => {
    	datatype => 'V1ReplicationControllerStatus',
    	base_name => 'status',
