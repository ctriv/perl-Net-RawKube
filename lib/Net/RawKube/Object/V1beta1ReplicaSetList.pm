...
#
package Net::RawKube::Object::V1beta1ReplicaSetList;
...
__PACKAGE__->class_documentation({description => 'ReplicaSetList is a collection of ReplicaSets.',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1beta1ReplicaSet]',
    	base_name => 'items',
