...
#
package Net::RawKube::Object::V1ServiceAccountList;
...
__PACKAGE__->class_documentation({description => 'ServiceAccountList is a list of ServiceAccount objects',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[V1ServiceAccount]',
    	base_name => 'items',
