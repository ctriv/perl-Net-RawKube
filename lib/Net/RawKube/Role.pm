...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'Net::RawKube::Configuration',
              );
...
sub _build_af {
	...
	return Net::RawKube::ApiFactory->new(%args);
}
...
=head2 Kubernetes version: v1.7.4
...
The tokens will be placed in the C<Net::RawKube::Configuration> namespace
as follows, but you don't need to know about this.

=over 4

=item C<$Net::RawKube::Configuration::username>

String. The username for basic auth.

=item C<$Net::RawKube::Configuration::password>

String. The password for basic auth.

=item C<$Net::RawKube::Configuration::api_key>
...
=item C<$Net::RawKube::Configuration::api_key_prefix>
...
=item C<$Net::RawKube::Configuration::access_token>
