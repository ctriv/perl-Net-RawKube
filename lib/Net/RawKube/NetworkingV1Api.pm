...
#
package Net::RawKube::NetworkingV1Api;
...
sub create_namespaced_network_policy {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1NetworkPolicy', $response);
...
sub delete_namespaced_network_policy {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1/';
...
sub list_namespaced_network_policy {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1NetworkPolicyList', $response);
    return $_response_object;
}
...
sub list_network_policy_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/networking.k8s.io/v1/networkpolicies';
