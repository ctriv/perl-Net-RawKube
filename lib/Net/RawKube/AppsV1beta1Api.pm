...
#
package Net::RawKube::AppsV1beta1Api;
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_namespaced_deployment_rollback' } = { 
    	summary => '',
        params => $params,
        returns => 'AppsV1beta1DeploymentRollback',
        };
}
...
sub create_namespaced_deployment_rollback {
    ...
    my $_response_object = $self->{api_client}->deserialize('AppsV1beta1DeploymentRollback', $response);
    return $_response_object;
}
...
sub delete_namespaced_controller_revision {
    ...
    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling delete_namespaced_controller_revision");
    }
...
sub delete_namespaced_stateful_set {
    ...
    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling delete_namespaced_stateful_set");
    }
