...
#
package Net::RawKube::AutoscalingV1Api;
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    'body' => {
        data_type => 'V1HorizontalPodAutoscaler',
        description => '',
        required => '1',
    },
    'pretty' => {
...
sub create_namespaced_horizontal_pod_autoscaler {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1HorizontalPodAutoscaler', $response);
...
sub delete_namespaced_horizontal_pod_autoscaler {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_horizontal_pod_autoscaler_for_all_namespaces' } = { 
    	summary => '',
        params => $params,
        returns => 'V1HorizontalPodAutoscalerList',
        };
}
...
sub list_horizontal_pod_autoscaler_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v1/horizontalpodautoscalers';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1HorizontalPodAutoscalerList', $response);
    return $_response_object;
}
...
sub patch_namespaced_horizontal_pod_autoscaler_status {
    ...
    # parse inputs
    my $_resource_path = '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status';
