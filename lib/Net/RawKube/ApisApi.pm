...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_api_versions' } = { 
    	summary => '',
        params => $params,
        returns => 'V1APIGroupList',
        };
}
# @return V1APIGroupList
#
sub get_api_versions {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/apis/';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1APIGroupList', $response);
