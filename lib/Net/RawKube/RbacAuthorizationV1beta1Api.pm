...
#
package Net::RawKube::RbacAuthorizationV1beta1Api;
...
sub create_cluster_role {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/clusterroles';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1ClusterRole', $response);
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    my $params = {
    'body' => {
        data_type => 'V1beta1ClusterRoleBinding',
        description => '',
        required => '1',
    },
    'pretty' => {
    ...
    __PACKAGE__->method_documentation->{ 'create_cluster_role_binding' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1ClusterRoleBinding',
        };
}
...
sub create_cluster_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1ClusterRoleBinding', $response);
    return $_response_object;
}
...
sub create_namespaced_role {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1Role', $response);
    return $_response_object;
}
...
sub create_namespaced_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1RoleBinding', $response);
    return $_response_object;
}
...
sub delete_cluster_role {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}';
...
sub delete_cluster_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name}';
...
sub delete_namespaced_role {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name}';
...
sub delete_namespaced_role_binding {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_cluster_role' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1ClusterRoleList',
        };
}
...
sub list_cluster_role {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1ClusterRoleList', $response);
    return $_response_object;
}
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_cluster_role_binding' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1ClusterRoleBindingList',
        };
}
...
sub list_cluster_role_binding {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1ClusterRoleBindingList', $response);
    return $_response_object;
}
...
sub list_namespaced_role {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1RoleList', $response);
    return $_response_object;
}
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_namespaced_role_binding' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1RoleBindingList',
        };
}
...
sub list_namespaced_role_binding {
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1RoleBindingList', $response);
    return $_response_object;
}
...
sub list_role_binding_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/rolebindings';
...
sub list_role_for_all_namespaces {
    ...
    # parse inputs
    my $_resource_path = '/apis/rbac.authorization.k8s.io/v1beta1/roles';
