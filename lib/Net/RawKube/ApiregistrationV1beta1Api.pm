...
#
package Net::RawKube::ApiregistrationV1beta1Api;
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_api_service' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1APIService',
        };
}
# @return V1beta1APIService
#
sub create_api_service {
    my ($self, %args) = @_;

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_api_service");
    }

    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1beta1/apiservices';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1APIService', $response);
...
# @param string $propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_api_service' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_api_service {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_api_service");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling delete_api_service");
    }

    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_api_service' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_api_service {
    my ($self, %args) = @_;
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1beta1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_api_service' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1APIServiceList',
        };
}
# @return V1beta1APIServiceList
#
sub list_api_service {
    my ($self, %args) = @_;
    ...
    my $_response_object = $self->{api_client}->deserialize('V1beta1APIServiceList', $response);
    return $_response_object;
}
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_api_service' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1APIService',
        };
...
# @return V1beta1APIService
#
sub patch_api_service {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_api_service");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_api_service");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_api_service' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1APIService',
        };
...
# @return V1beta1APIService
#
sub read_api_service {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_api_service");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_api_service' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1APIService',
        };
...
# @return V1beta1APIService
#
sub replace_api_service {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_api_service");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_api_service");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_api_service_status' } = { 
    	summary => '',
        params => $params,
        returns => 'V1beta1APIService',
        };
...
# @return V1beta1APIService
#
sub replace_api_service_status {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_api_service_status");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_api_service_status");
    }

    # parse inputs
    my $_resource_path = '/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status';
