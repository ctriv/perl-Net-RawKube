...
#
package Net::RawKube::SettingsV1alpha1Api;
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_namespaced_pod_preset' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PodPreset',
        };
}
# @return V1alpha1PodPreset
#
sub create_namespaced_pod_preset {
    my ($self, %args) = @_;

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling create_namespaced_pod_preset");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_namespaced_pod_preset");
    }

    # parse inputs
    my $_resource_path = '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets';
    ...
    my $_response_object = $self->{api_client}->deserialize('V1alpha1PodPreset', $response);
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_collection_namespaced_pod_preset' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_collection_namespaced_pod_preset {
    my ($self, %args) = @_;

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling delete_collection_namespaced_pod_preset");
    }
...
# @param string $propagation_policy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_namespaced_pod_preset' } = { 
    	summary => '',
        params => $params,
        returns => 'V1Status',
        };
...
# @return V1Status
#
sub delete_namespaced_pod_preset {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling delete_namespaced_pod_preset");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling delete_namespaced_pod_preset");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling delete_namespaced_pod_preset");
    }

    # parse inputs
    my $_resource_path = '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}';
...
sub get_api_resources {
    ...
    # parse inputs
    my $_resource_path = '/apis/settings.k8s.io/v1alpha1/';
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_namespaced_pod_preset' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PodPresetList',
        };
}
# @return V1alpha1PodPresetList
#
sub list_namespaced_pod_preset {
    my ($self, %args) = @_;

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling list_namespaced_pod_preset");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('V1alpha1PodPresetList', $response);
    return $_response_object;
}
...
# @param boolean $watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'list_pod_preset_for_all_namespaces' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PodPresetList',
        };
...
# @return V1alpha1PodPresetList
#
sub list_pod_preset_for_all_namespaces {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/apis/settings.k8s.io/v1alpha1/podpresets';
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'patch_namespaced_pod_preset' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PodPreset',
        };
...
# @return V1alpha1PodPreset
#
sub patch_namespaced_pod_preset {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling patch_namespaced_pod_preset");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling patch_namespaced_pod_preset");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling patch_namespaced_pod_preset");
    }
...
# @param boolean $export Should this value be exported.  Export strips fields that a user can not specify. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'read_namespaced_pod_preset' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PodPreset',
        };
...
# @return V1alpha1PodPreset
#
sub read_namespaced_pod_preset {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling read_namespaced_pod_preset");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling read_namespaced_pod_preset");
    }
...
# @param string $pretty If &#39;true&#39;, then the output is pretty printed. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'replace_namespaced_pod_preset' } = { 
    	summary => '',
        params => $params,
        returns => 'V1alpha1PodPreset',
        };
...
# @return V1alpha1PodPreset
#
sub replace_namespaced_pod_preset {
    my ($self, %args) = @_;

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling replace_namespaced_pod_preset");
    }

    # verify the required parameter 'namespace' is set
    unless (exists $args{'namespace'}) {
      croak("Missing the required parameter 'namespace' when calling replace_namespaced_pod_preset");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling replace_namespaced_pod_preset");
    }
