# Net::RawKube::AuthorizationV1beta1Api

## Load the API package
```perl
use Net::RawKube::Object::AuthorizationV1beta1Api;
```
...
> V1beta1LocalSubjectAccessReview create_namespaced_local_subject_access_review(namespace => $namespace, body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::AuthorizationV1beta1Api->new();
my $namespace = 'namespace_example'; # string | object name and auth scope, such as for teams and projects
my $body = Net::RawKube::Object::V1beta1LocalSubjectAccessReview->new(); # V1beta1LocalSubjectAccessReview | 
...
> V1beta1SelfSubjectAccessReview create_self_subject_access_review(body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::AuthorizationV1beta1Api->new();
my $body = Net::RawKube::Object::V1beta1SelfSubjectAccessReview->new(); # V1beta1SelfSubjectAccessReview | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.
...
> V1beta1SubjectAccessReview create_subject_access_review(body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::AuthorizationV1beta1Api->new();
my $body = Net::RawKube::Object::V1beta1SubjectAccessReview->new(); # V1beta1SubjectAccessReview | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.
