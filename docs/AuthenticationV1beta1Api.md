# Net::RawKube::AuthenticationV1beta1Api

## Load the API package
```perl
use Net::RawKube::Object::AuthenticationV1beta1Api;
```
...
# **create_token_review**
> V1beta1TokenReview create_token_review(body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::AuthenticationV1beta1Api->new();
my $body = Net::RawKube::Object::V1beta1TokenReview->new(); # V1beta1TokenReview | 
