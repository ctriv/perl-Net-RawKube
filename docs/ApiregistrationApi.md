# Net::RawKube::ApiregistrationApi

## Load the API package
```perl
use Net::RawKube::Object::ApiregistrationApi;
```
...
my $api_instance = Net::RawKube::ApiregistrationApi->new();
...
if ($@) {
    warn "Exception when calling ApiregistrationApi->get_api_group: $@\n";
}
```
