# Net::RawKube::CertificatesV1beta1Api

## Load the API package
```perl
use Net::RawKube::Object::CertificatesV1beta1Api;
```
...
> V1beta1CertificateSigningRequest create_certificate_signing_request(body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::CertificatesV1beta1Api->new();
my $body = Net::RawKube::Object::V1beta1CertificateSigningRequest->new(); # V1beta1CertificateSigningRequest | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.

eval { 
    my $result = $api_instance->create_certificate_signing_request(body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->create_certificate_signing_request: $@\n";
}
```
...
> V1Status delete_certificate_signing_request(name => $name, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy)
...
my $api_instance = Net::RawKube::CertificatesV1beta1Api->new();
my $name = 'name_example'; # string | name of the CertificateSigningRequest
...
eval { 
    my $result = $api_instance->delete_certificate_signing_request(name => $name, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->delete_certificate_signing_request: $@\n";
}
```
...
eval { 
    my $result = $api_instance->delete_collection_certificate_signing_request(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->delete_collection_certificate_signing_request: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->get_api_resources: $@\n";
}
```
...
eval { 
    my $result = $api_instance->list_certificate_signing_request(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->list_certificate_signing_request: $@\n";
}
```
...
> V1beta1CertificateSigningRequest patch_certificate_signing_request(name => $name, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->patch_certificate_signing_request(name => $name, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->patch_certificate_signing_request: $@\n";
}
```
...
> V1beta1CertificateSigningRequest read_certificate_signing_request(name => $name, pretty => $pretty, exact => $exact, export => $export)
...
eval { 
    my $result = $api_instance->read_certificate_signing_request(name => $name, pretty => $pretty, exact => $exact, export => $export);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->read_certificate_signing_request: $@\n";
}
```
...
> V1beta1CertificateSigningRequest replace_certificate_signing_request(name => $name, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_certificate_signing_request(name => $name, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->replace_certificate_signing_request: $@\n";
}
```
...
> V1beta1CertificateSigningRequest replace_certificate_signing_request_approval(name => $name, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_certificate_signing_request_approval(name => $name, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->replace_certificate_signing_request_approval: $@\n";
}
```
...
> V1beta1CertificateSigningRequest replace_certificate_signing_request_status(name => $name, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_certificate_signing_request_status(name => $name, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CertificatesV1beta1Api->replace_certificate_signing_request_status: $@\n";
}
```
