# Net::RawKube::SettingsV1alpha1Api

## Load the API package
```perl
use Net::RawKube::Object::SettingsV1alpha1Api;
```
...
> V1alpha1PodPreset create_namespaced_pod_preset(namespace => $namespace, body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::SettingsV1alpha1Api->new();
my $namespace = 'namespace_example'; # string | object name and auth scope, such as for teams and projects
my $body = Net::RawKube::Object::V1alpha1PodPreset->new(); # V1alpha1PodPreset | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.

eval { 
    my $result = $api_instance->create_namespaced_pod_preset(namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
...
> V1Status delete_collection_namespaced_pod_preset(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->delete_collection_namespaced_pod_preset(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V1Status delete_namespaced_pod_preset(name => $name, namespace => $namespace, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy)
...
eval { 
    my $result = $api_instance->delete_namespaced_pod_preset(name => $name, namespace => $namespace, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy);
    print Dumper($result);
};
if ($@) {
...
> V1alpha1PodPresetList list_namespaced_pod_preset(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_namespaced_pod_preset(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V1alpha1PodPresetList list_pod_preset_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_pod_preset_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V1alpha1PodPreset patch_namespaced_pod_preset(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->patch_namespaced_pod_preset(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
...
> V1alpha1PodPreset replace_namespaced_pod_preset(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_namespaced_pod_preset(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
