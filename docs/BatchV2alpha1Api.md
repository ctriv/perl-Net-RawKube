# Net::RawKube::BatchV2alpha1Api

## Load the API package
```perl
use Net::RawKube::Object::BatchV2alpha1Api;
```
...
> V2alpha1CronJob create_namespaced_cron_job(namespace => $namespace, body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::BatchV2alpha1Api->new();
my $namespace = 'namespace_example'; # string | object name and auth scope, such as for teams and projects
my $body = Net::RawKube::Object::V2alpha1CronJob->new(); # V2alpha1CronJob | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.

eval { 
    my $result = $api_instance->create_namespaced_cron_job(namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
...
> V2alpha1CronJob create_namespaced_scheduled_job(namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->create_namespaced_scheduled_job(namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->create_namespaced_scheduled_job: $@\n";
}
```
...
> V1Status delete_collection_namespaced_cron_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->delete_collection_namespaced_cron_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V1Status delete_collection_namespaced_scheduled_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->delete_collection_namespaced_scheduled_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->delete_collection_namespaced_scheduled_job: $@\n";
}
```
...
> V1Status delete_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy)
...
eval { 
    my $result = $api_instance->delete_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy);
    print Dumper($result);
};
if ($@) {
...
> V1Status delete_namespaced_scheduled_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy)
...
my $api_instance = Net::RawKube::BatchV2alpha1Api->new();
my $name = 'name_example'; # string | name of the ScheduledJob
my $namespace = 'namespace_example'; # string | object name and auth scope, such as for teams and projects
my $body = Net::RawKube::Object::V1DeleteOptions->new(); # V1DeleteOptions | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.
my $grace_period_seconds = 56; # int | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
...
eval { 
    my $result = $api_instance->delete_namespaced_scheduled_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->delete_namespaced_scheduled_job: $@\n";
}
```
...
> V2alpha1CronJobList list_cron_job_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_cron_job_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V2alpha1CronJobList list_namespaced_cron_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_namespaced_cron_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
...
> V2alpha1CronJobList list_namespaced_scheduled_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_namespaced_scheduled_job(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->list_namespaced_scheduled_job: $@\n";
}
```
...
> V2alpha1CronJobList list_scheduled_job_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_scheduled_job_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->list_scheduled_job_for_all_namespaces: $@\n";
}
```
...
> V2alpha1CronJob patch_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->patch_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
...
> V2alpha1CronJob patch_namespaced_cron_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->patch_namespaced_cron_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
...
> V2alpha1CronJob patch_namespaced_scheduled_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->patch_namespaced_scheduled_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->patch_namespaced_scheduled_job: $@\n";
}
```
...
> V2alpha1CronJob patch_namespaced_scheduled_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->patch_namespaced_scheduled_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->patch_namespaced_scheduled_job_status: $@\n";
}
```
...
> V2alpha1CronJob read_namespaced_scheduled_job(name => $name, namespace => $namespace, pretty => $pretty, exact => $exact, export => $export)
...
eval { 
    my $result = $api_instance->read_namespaced_scheduled_job(name => $name, namespace => $namespace, pretty => $pretty, exact => $exact, export => $export);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->read_namespaced_scheduled_job: $@\n";
}
```
...
> V2alpha1CronJob read_namespaced_scheduled_job_status(name => $name, namespace => $namespace, pretty => $pretty)
...
eval { 
    my $result = $api_instance->read_namespaced_scheduled_job_status(name => $name, namespace => $namespace, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->read_namespaced_scheduled_job_status: $@\n";
}
```
...
> V2alpha1CronJob replace_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_namespaced_cron_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
...
> V2alpha1CronJob replace_namespaced_cron_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_namespaced_cron_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
...
> V2alpha1CronJob replace_namespaced_scheduled_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_namespaced_scheduled_job(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->replace_namespaced_scheduled_job: $@\n";
}
```
...
> V2alpha1CronJob replace_namespaced_scheduled_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_namespaced_scheduled_job_status(name => $name, namespace => $namespace, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BatchV2alpha1Api->replace_namespaced_scheduled_job_status: $@\n";
}
```
