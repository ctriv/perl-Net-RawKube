# Net::RawKube::AuthorizationApi

## Load the API package
```perl
use Net::RawKube::Object::AuthorizationApi;
```
...
my $api_instance = Net::RawKube::AuthorizationApi->new();
...
if ($@) {
    warn "Exception when calling AuthorizationApi->get_api_group: $@\n";
}
```
