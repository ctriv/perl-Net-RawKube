# Net::RawKube::RbacAuthorizationV1alpha1Api

## Load the API package
```perl
use Net::RawKube::Object::RbacAuthorizationV1alpha1Api;
```
...
# **create_cluster_role**
> V1alpha1ClusterRole create_cluster_role(body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::RbacAuthorizationV1alpha1Api->new();
my $body = Net::RawKube::Object::V1alpha1ClusterRole->new(); # V1alpha1ClusterRole | 
...
> V1alpha1ClusterRoleBinding create_cluster_role_binding(body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::RbacAuthorizationV1alpha1Api->new();
my $body = Net::RawKube::Object::V1alpha1ClusterRoleBinding->new(); # V1alpha1ClusterRoleBinding | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.
...
> V1alpha1Role create_namespaced_role(namespace => $namespace, body => $body, pretty => $pretty)
...
my $body = Net::RawKube::Object::V1alpha1Role->new(); # V1alpha1Role | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.
...
> V1alpha1RoleBinding create_namespaced_role_binding(namespace => $namespace, body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::RbacAuthorizationV1alpha1Api->new();
my $namespace = 'namespace_example'; # string | object name and auth scope, such as for teams and projects
my $body = Net::RawKube::Object::V1alpha1RoleBinding->new(); # V1alpha1RoleBinding | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.
...
# **list_cluster_role**
> V1alpha1ClusterRoleList list_cluster_role(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
> V1alpha1ClusterRoleBindingList list_cluster_role_binding(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
> V1alpha1RoleList list_namespaced_role(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
> V1alpha1RoleBindingList list_namespaced_role_binding(namespace => $namespace, pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
> V1alpha1RoleBindingList list_role_binding_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
> V1alpha1RoleList list_role_for_all_namespaces(field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, pretty => $pretty, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
# **patch_cluster_role**
> V1alpha1ClusterRole patch_cluster_role(name => $name, body => $body, pretty => $pretty)
...
> V1alpha1ClusterRoleBinding patch_cluster_role_binding(name => $name, body => $body, pretty => $pretty)
...
> V1alpha1Role patch_namespaced_role(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
> V1alpha1RoleBinding patch_namespaced_role_binding(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
> V1alpha1ClusterRole replace_cluster_role(name => $name, body => $body, pretty => $pretty)
...
> V1alpha1ClusterRoleBinding replace_cluster_role_binding(name => $name, body => $body, pretty => $pretty)
...
> V1alpha1Role replace_namespaced_role(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
...
> V1alpha1RoleBinding replace_namespaced_role_binding(name => $name, namespace => $namespace, body => $body, pretty => $pretty)
