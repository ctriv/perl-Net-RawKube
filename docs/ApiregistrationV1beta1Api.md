# Net::RawKube::ApiregistrationV1beta1Api

## Load the API package
```perl
use Net::RawKube::Object::ApiregistrationV1beta1Api;
```
...
# **create_api_service**
> V1beta1APIService create_api_service(body => $body, pretty => $pretty)
...
my $api_instance = Net::RawKube::ApiregistrationV1beta1Api->new();
my $body = Net::RawKube::Object::V1beta1APIService->new(); # V1beta1APIService | 
my $pretty = 'pretty_example'; # string | If 'true', then the output is pretty printed.

eval { 
    my $result = $api_instance->create_api_service(body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->create_api_service: $@\n";
}
```
...
# **delete_api_service**
> V1Status delete_api_service(name => $name, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy)
...
my $api_instance = Net::RawKube::ApiregistrationV1beta1Api->new();
my $name = 'name_example'; # string | name of the APIService
...
eval { 
    my $result = $api_instance->delete_api_service(name => $name, body => $body, pretty => $pretty, grace_period_seconds => $grace_period_seconds, orphan_dependents => $orphan_dependents, propagation_policy => $propagation_policy);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->delete_api_service: $@\n";
}
```
...
> V1Status delete_collection_api_service(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->delete_collection_api_service(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->delete_collection_api_service: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->get_api_resources: $@\n";
}
```
...
# **list_api_service**
> V1beta1APIServiceList list_api_service(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch)
...
eval { 
    my $result = $api_instance->list_api_service(pretty => $pretty, field_selector => $field_selector, include_uninitialized => $include_uninitialized, label_selector => $label_selector, resource_version => $resource_version, timeout_seconds => $timeout_seconds, watch => $watch);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->list_api_service: $@\n";
}
```
...
# **patch_api_service**
> V1beta1APIService patch_api_service(name => $name, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->patch_api_service(name => $name, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->patch_api_service: $@\n";
}
```
...
# **read_api_service**
> V1beta1APIService read_api_service(name => $name, pretty => $pretty, exact => $exact, export => $export)
...
eval { 
    my $result = $api_instance->read_api_service(name => $name, pretty => $pretty, exact => $exact, export => $export);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->read_api_service: $@\n";
}
```
...
# **replace_api_service**
> V1beta1APIService replace_api_service(name => $name, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_api_service(name => $name, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->replace_api_service: $@\n";
}
```
...
> V1beta1APIService replace_api_service_status(name => $name, body => $body, pretty => $pretty)
...
eval { 
    my $result = $api_instance->replace_api_service_status(name => $name, body => $body, pretty => $pretty);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ApiregistrationV1beta1Api->replace_api_service_status: $@\n";
}
```
