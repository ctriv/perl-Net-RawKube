# Net::RawKube::CertificatesApi

## Load the API package
```perl
use Net::RawKube::Object::CertificatesApi;
```
...
my $api_instance = Net::RawKube::CertificatesApi->new();
...
if ($@) {
    warn "Exception when calling CertificatesApi->get_api_group: $@\n";
}
```
