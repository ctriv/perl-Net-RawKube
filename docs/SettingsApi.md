# Net::RawKube::SettingsApi

## Load the API package
```perl
use Net::RawKube::Object::SettingsApi;
```
...
my $api_instance = Net::RawKube::SettingsApi->new();
...
if ($@) {
    warn "Exception when calling SettingsApi->get_api_group: $@\n";
}
```
