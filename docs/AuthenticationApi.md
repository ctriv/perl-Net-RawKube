# Net::RawKube::AuthenticationApi

## Load the API package
```perl
use Net::RawKube::Object::AuthenticationApi;
```
...
my $api_instance = Net::RawKube::AuthenticationApi->new();
...
if ($@) {
    warn "Exception when calling AuthenticationApi->get_api_group: $@\n";
}
```
